...
public class ShapeRelativeLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //填充颜色
        solidColor = ta.getInteger(R.styleable.ShapeRelativeLayout_solidColor, 0x00000000);
        //边框颜色
        strokeColor = ta.getInteger(R.styleable.ShapeRelativeLayout_strokeColor, 0x00000000);
        startColor = ta.getInteger(R.styleable.ShapeRelativeLayout_startColor, 0x00000000);
        endColor = ta.getInteger(R.styleable.ShapeRelativeLayout_endColor, 0x00000000);
        //边框宽度
        strokeWidth = (int) ta.getDimension(R.styleable.ShapeRelativeLayout_strokeWidth, 0);
        //四个角单独设置会覆盖radius设置
        radius = ta.getDimension(R.styleable.ShapeRelativeLayout_radius, 0);
        topLeftRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_topLeftRadius, radius);
        topRightRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_topRightRadius, radius);
        bottomLeftRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_bottomLeftRadius, radius);
        bottomRightRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_bottomRightRadius, radius);

        dashGap = ta.getDimension(R.styleable.ShapeRelativeLayout_dashGap, 0);
        dashWidth = ta.getDimension(R.styleable.ShapeRelativeLayout_dashWidth, 0);

        orientation = ta.getInt(R.styleable.ShapeRelativeLayout_orientation, 0);
        ta.recycle();
    }
